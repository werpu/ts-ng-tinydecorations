...
describe('RequestParamTest', () => {
    it('should have the inner params transferred', function() {
        ...
        expect((<any>RestService).prototype["myRequest"][C_REQ_PARAMS][0].name).toBe(DEF_NAME);
        expect((<any>RestService).prototype["myRequest"][C_REQ_PARAMS][0].paramType).toBe(PARAM_TYPE.URL);
    });
